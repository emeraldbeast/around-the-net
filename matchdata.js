  ...
  },
  {
    ...
    submatches: [
      ...
      },
      {
        ...
        playerA: "Tanmay Rao",
        playerB: "Ammar Abdul Azeez",
        games: ["11-8", "11-8", "-"], //When Match starts, replace Scheduled with - - -, and then keep adding scores
        winner: "Tanmay Rao",
        status: "Completed", //Change this to Ongoing, when game starts, then change to Completed when game over
      },
      {
        ...
        playerA: "Hriday Sama",
        playerB: "Aaditya Lahori",
        games: ["11-9", "7-11", "11-9"], //When Match starts, replace Scheduled with - - -, and then keep adding scores
        winner: "Hriday Sama",
        status: "Completed", //Change this to Ongoing, when game starts, then change to Completed when game over
      },
      {
        game: "Doubles",
        playerA: "Omkar Vanjari & Aadinath Keshav",
        playerB: "Animesh Gaonkar & Abhinav Padhi",
        games: ["8-11", "6-11", "-"], //When Match starts, replace Scheduled with - - -, and then keep adding scores
        winner: "Animesh Gaonkar & Abhinav Padhi",
        status: "Completed", //Change this to Ongoing, when game starts, then change to Completed when game over
      },
      {
        game: "Singles D",
  ...
  },
  {
    ...
    submatches: [
      ...
      },
      {
        ...
        playerA: "Atharv Mehta",
        playerB: "Aarush Goyal",
        games: ["5-11", "11-6", "9-11"], //When Match starts, replace Scheduled with - - -, and then keep adding scores
        winner: "Aarush Goyal",
        status: "Completed", //Change this to Ongoing, when game starts, then change to Completed when game over
      },
      {
      ...
      {
        game: "Doubles",
        playerA: "Kanupriya Vyas & Saatvik Chaturvedi",
        playerB: "Jatin Vasandani & Tanay Mody",
        games: ["9-11", "11-5", "12-10"], //When Match starts, replace Scheduled with - - -, and then keep adding scores
        winner: "Kanupriya Vyas & Saatvik Chaturvedi",
        status: "Completed", //Change this to Ongoing, when game starts, then change to Completed when game over
      },
      {
        game: "Singles D",
    ...
    submatches: [
      {
        ...
        playerA: "Ammar Abdul Azeez",
        playerB: "Pranav Narayan",
        games: ["8-11", "11-7", "8-11", "8-11", "-"], //When Match starts, replace Scheduled with - - -, and then keep adding scores
        winner: "Pranav Narayan",
        status: "Completed", //Change this to Ongoing, when game starts, then change to Completed when game over
      },
      {
        game: "Singles B",
        playerA: "Shrish Lohiya",
        playerB: "Mihir Kulkarni",
        games: ["5-11", "9-11", "14-12", "6-11", "-"], //When Match starts, replace Scheduled with - - -, and then keep adding scores
        winner: "Mihir Kulkarni",
        status: "Completed", //Change this to Ongoing, when game starts, then change to Completed when game over
      },
      {
        game: "Singles C",
        playerA: "Aaditya Lahori",
        playerB: "Arya Jain",
        games: ["6-11", "8-11", "9-11", "-", "-"], //When Match starts, replace Scheduled with - - -, and then keep adding scores
        winner: "Arya Jain",
        status: "Completed", //Change this to Ongoing, when game starts, then change to Completed when game over
      },
      {
        game: "Doubles",
        playerA: "Abhinav Padhi & Animesh Gaonkar",
        playerB: "Walkover",
        games: ["0-0", "0-0", "0-0", "-", "-"], //When Match starts, replace Scheduled with - - -, and then keep adding scores
        winner: "Abhinav Padhi & Animesh Gaonkar",
        status: "Completed", //Change this to Ongoing, when game starts, then change to Completed when game over
      },
      {
    ...
    submatches: [
      {
        ...
        playerA: "Nachiket Khandekar",
        playerB: "Prasham Bhayani",
        games: ["11-1", "11-4", "11-1", "-", "-"], //When Match starts, replace Scheduled with - - -, and then keep adding scores
        winner: "Nachiket Khandekar",
        status: "Completed", //Change this to Ongoing, when game starts, then change to Completed when game over
      },
      {
        ...
        playerA: "Arindam Bose",
        playerB: "Mihir Kulkarni",
        games: ["8-11", "7-11", "10-12", "-", "-"], //When Match starts, replace Scheduled with - - -, and then keep adding scores
        winner: "Mihir Kulkarni",
        status: "Completed", //Change this to Ongoing, when game starts, then change to Completed when game over
      },
      {
        ...
        playerA: "Aryan Gagare",
        playerB: "Arya Jain",
        games: ["6-11", "11-4", "7-11", "11-9", "8-11"], //When Match starts, replace Scheduled with - - -, and then keep adding scores
        winner: "Arya Jain",
        status: "Completed", //Change this to Ongoing, when game starts, then change to Completed when game over
      },
      {
        game: "Doubles",
        playerA: "Shreyash Narayanan & Harshwardhan Shah",
        playerB: "Pranav Narayan & Vedang Krishna",
        games: ["11-5", "11-8", "11-8", "-", "-"], //When Match starts, replace Scheduled with - - -, and then keep adding scores
        winner: "Shreyash Narayanan & Harshwardhan Shah",
        status: "Completed", //Change this to Ongoing, when game starts, then change to Completed when game over
      },
      {
        game: "Singles D",
        playerA: "Nachiket Khandekar",
        playerB: "Mihir Kulkarni",
        games: ["8-11", "6-11", "11-8", "7-11", "-"], //When Match starts, replace Scheduled with - - -, and then keep adding scores
        winner: "Mihir Kulkarni",
        status: "Completed", //Change this to Ongoing, when game starts, then change to Completed when game over
      },
      {
        ...
        playerA: "Arindam Bose",
        playerB: "Prasham Bhayani",
        games: ["8-11", "11-9", "8-11", "11-9", "14-12"], //When Match starts, replace Scheduled with - - -, and then keep adding scores
        winner: "Arindam Bose",
        status: "Completed", //Change this to Ongoing, when game starts, then change to Completed when game over
      },
    ],
